...
*/
  ...
  */  
    ...
    public final void readBusDetails(){
        ...
        try(Scanner read = new Scanner(new FileInputStream(this.inputFile));
            PrintWriter pw = new PrintWriter(new FileOutputStream(".txt"))){
...
//      int i=0;
      ...
      for(int i=0; i<bus.length; i++){
          ...
          //if(alineID.compareTo(getBusNumber) == 0){
            //  if(bus[i].getDepartureAirport().compareTo(departureAirport) == 0 && bus[i].getDestinationAirport().compareTo(destinationAirport) == 0){
